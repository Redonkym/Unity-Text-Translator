...
{
    /// <summary>
    /// Пошаговый мастер замены шрифта на кириллицу (кнопки слева направо):
    /// 1) Анализ .assets → 2) Создать атлас из TTF → 3) Патч (рост кириллицы) → 4) Применить.
    /// Работает для любой игры: PathID шрифта и размер атласа берутся из анализа.
    /// </summary>
